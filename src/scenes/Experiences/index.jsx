...
class Experience extends Component {
  ...
  render() {
    ...
    console.log(idx);
    const json = this.props.experiences.experiences[idx];
    console.log(json);
    ...
    const description = descriptions.hasOwnProperty(cityName)
      ? descriptions[cityName]
      : descriptions['Default'];

    const activities = activitiesJson.map(activity => (
      <Activity
        key={activity.businessName}
        ...
        <div className="experience">
          ...
          <div className="section">
            ...
            <Paper elevation={4} className="flight-container">
              ...
              <Icon color="action" fontSize={true} className="flight-icon">
                airplanemode_active
              </Icon>
              <div className="info-container">
